...
let mus = [
    ['Parasol', 2, subs[0], subs[3], '../docs/assets/images/parasol.png', [4, 7], [0, 3], 0]
    , ['Mycena', 3, subs[1], subs[4], '../docs/assets/images/mycena.png', [1, 2], [5, 6], 5]
    , ['Boletus', 4, subs[2], subs[5], '../docs/assets/images/boletus.png', [0, 5], [1, 4], 10]
    , ['Field', 5, subs[0], subs[4], '../docs/assets/images/field.png', [3, 6], [2, 7], 15]
    , ['Goblin', 5, subs[2], subs[3], '../docs/assets/images/goblin.png', [0, 3], [4, 7], 20]
    , ['Blusher', 6, subs[2], subs[5], '../docs/assets/images/blusher.png', [0, 5], [1, 4], 20]
    , ['Milk Cap', 7, subs[0], subs[3], '../docs/assets/images/milk.png', [4, 7], [0, 3], 25]
    , ['Blastcap', 8, subs[0], subs[5], '../docs/assets/images/blastcap.png', [4, 5], [0, 1], 25]
    , ['Blood', 8, subs[1], subs[3], '../docs/assets/images/blood.png', [1, 6], [2, 3], 30]
    , ['Coral', 9, subs[1], subs[5], '../docs/assets/images/coral.png', [2, 3], [6, 7], 35]
    , ['Iocaine', 10, subs[1], subs[4], '../docs/assets/images/iocaine.png', [1, 2], [5, 6], 40]
    , ['Groxmax', 11, subs[0], subs[4], '../docs/assets/images/groxmax.png', [3, 6], [2, 7], 47]
    , ['False Agaric', 12, subs[1], subs[4], '../docs/assets/images/false.png', [6, 7], [2, 3], 50]
    , ['Porcini', 12, subs[2], subs[5], '../docs/assets/images/porcini.png', [4, 5], [0, 1], 55]
    , ['Black Foot', 13, subs[2], subs[3], '../docs/assets/images/black.png', [0, 7], [6, 6], 63]
    , ['Wizard\'s', 13, subs[0], subs[4], '../docs/assets/images/wizards.png', [1, 2], [3, 6], 75]
    , ['Pixie\'s', 14, subs[0], subs[5], '../docs/assets/images/pixies.png', [2, 3], [6, 7], 70]
    , ['Fly Amanita', 15, subs[0], subs[4], '../docs/assets/images/fly.png', [1, 4], [0, 5], 75]
    , ['Charged Mycelium', 16, subs[2], subs[5], '../docs/assets/images/charged.png', [0, 3], [7, 4], 85]
];

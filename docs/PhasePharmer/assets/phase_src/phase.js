...
let mus = [
    ...
    , ['Field', 5, subs[0], subs[4], '../phase_img/field.png', [3, 6], [2, 7], 15]
    , ['Goblin', 5, subs[2], subs[3], '../phase_img/goblin.png', [0, 3], [4, 7], 20]
    , ['Blusher', 6, subs[2], subs[5], '../phase_img/blusher.png', [0, 5], [1, 4], 20]
    , ['Milk Cap', 7, subs[0], subs[3], '../phase_img/milk.png', [4, 7], [0, 3], 25]
    , ['Blastcap', 8, subs[0], subs[5], '../phase_img/blastcap.png', [4, 5], [0, 1], 25]
    , ['Blood', 8, subs[1], subs[3], '../phase_img/blood.png', [1, 6], [2, 3], 30]
    , ['Coral', 9, subs[1], subs[5], '../phase_img/coral.png', [2, 3], [6, 7], 35]
    , ['Iocaine', 10, subs[1], subs[4], '../phase_img/iocaine.png', [1, 2], [5, 6], 40]
    , ['Groxmax', 11, subs[0], subs[4], '../phase_img/groxmax.png', [3, 6], [2, 7], 47]
    , ['False Agaric', 12, subs[1], subs[4], '../phase_img/false.png', [6, 7], [2, 3], 50]
    , ['Porcini', 12, subs[2], subs[5], '../phase_img/porcini.png', [4, 5], [0, 1], 55]
    , ['Black Foot', 13, subs[2], subs[3], '../phase_img/black.png', [0, 7], [6, 6], 63]
    , ['Wizard\'s', 13, subs[0], subs[4], '../phase_img/wizards.png', [1, 2], [3, 6], 75]
    , ['Pixie\'s', 14, subs[0], subs[5], '../phase_img/pixies.png', [2, 3], [6, 7], 70]
    , ['Fly Amanita', 15, subs[0], subs[4], '../phase_img/fly.png', [1, 4], [0, 5], 75]
    , ['Charged Mycelium', 16, subs[2], subs[5], '../phase_img/charged.png', [0, 3], [7, 4], 85]
];
